...
public class UpdateNoticeAction implements Action{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String num = request.getParameter("notice_number");
		...
		NoticeDto dto = new NoticeDto(Integer.parseInt(num), id, title, content);
		dao.updateNotice(dto);
		
		String url = "noticedetail?&notice_number=" + num;
