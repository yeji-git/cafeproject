...
<script type="text/javascript" src="resources/agree.js"></script>
</head>
<body>
	<div class="regist-banner"></div>
	<div class="subject"><h2>회 원 가 입</h2></div>
	<form action="regist" name="form" method="post">
		<table class="agree">
			<tr>
				<td>
					<p>Compose Coffee 약관동의</p>
					<textarea rows="20" cols="150">
제 1 장 총칙

제 1 조 (목적)
본 약관은 컴포즈 커피(이하 "당 사이트")에서 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
...
① 회원의 개인정보는 개인정보보호법에 의해 보호되며 당 사이트의 개인정보처리방침이 적용됩니다.
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
			...
			<tr>
				<td class="agree-button-box"><input type="button" class="button-yellow" value="동의"
					onclick="chk()" />&nbsp;&nbsp;&nbsp; <input type="button" class="button-yellow" 
					value="비동의" onclick="nochk()" /></td>
			</tr>
		</table>
	</form>
